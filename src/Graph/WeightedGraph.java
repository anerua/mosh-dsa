...
public class WeightedGraph {
    ...
    public WeightedGraph getMinimumSpanningTree() {
        ...
        var startNode = nodes.entrySet().iterator().next();
        edges.addAll(startNode.getValue());
        tree.addNode(startNode.getKey().label);
        ...
        while (tree.nodes.size() < nodes.size()) {
            ...
            for (Edge edge : nodes.get(nextNode))
    ...
    public boolean containsNode(String label) {
        return nodes.containsKey(new Node(label));
    }
